...
<head>
    ...
    <style>
        body{
            background: linear-gradient(180deg, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.5) 100%), url('http://www.manilagenz.com/images2/file-1659968623048.jpeg') no-repeat center/cover;
            min-height:100vh;
        }
    </style>
</head>
