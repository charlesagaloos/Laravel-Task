      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="btn-group">
               <div class="btn">
                <div>
                    <a class="btn btn-warning" data-toggle="modal" data-target="#modal-add">Add New Student</a>
                </div>
            </div>

            <div class="btn">
                <div>
                    <a class="btn btn-danger" href="{{ route('student.downloadpdf')}}">Download PDF</a>
                </div>
            </div>

            <div class="btn">
                <div>
                    <a class="btn btn-success" href="{{ route('student.importform')}}">Import Excel File</a>
                </div>
            </div>
